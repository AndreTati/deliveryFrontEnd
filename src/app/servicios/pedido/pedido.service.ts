...
export class PedidoService {
  ...
  updateEstado(id:number, status:number, pedido:pedidoInterface){
    return this.httpApiService.put<pedidoInterface>(this._urlAllPedidos+'changeStatus/'+id+'/'+status,pedido);
  }
